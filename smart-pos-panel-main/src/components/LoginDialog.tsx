...
export function LoginDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const [email, setEmail] = useState("admin@bookpos.com");
    ...
    >
      ...
      >
        ...
        <form onSubmit={submit} className="mt-7 space-y-4">
          ...
          <button
            type="submit"
            className="h-11 w-full rounded-lg bg-primary text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition hover:opacity-90"
          >
            Sign in
          </button>
